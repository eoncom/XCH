...
**Commit message:**
```
docs(status): bump version label to v1.7.1 + smoke prod vert (partial unique index appliqué)
```
...
**Commit message:**
```
feat(rbac): permission helpers harmonization + ADR-021 (Session 4a PR1)
```
...
**Commit message:**
```
Merge pull request #6 from eoncom/claude/session-5-pr5-release
```
...
**Commit message:**
```
Merge pull request #7 from eoncom/claude/session-6-pr1-network-error-foundations
```
...
**Commit message:**
```
Merge pull request #15 from eoncom/claude/session-7-pr1
```
...
**Commit message:**
```
Merge pull request #24 from eoncom/claude/session-7-pr5f
```
...
**Commit message:**
```
Merge pull request #27 from eoncom/claude/session-7-pr5i
```
...
**Commit message:**
```
Merge pull request #30 from eoncom/claude/post-v1.9.0-severity-fix
```
...
**Commit message:**
```
feat(s9-pr3): notifications Response DTOs + as any cleanup (#39)
```
...
**Commit message:**
```
feat(s9-pr5): racks Response DTOs + Prisma JSON @Transform pattern (#41)
```
...
**Commit message:**
```
chore: add scripts/smoke-prod.sh — 5 endpoints smoke standard pattern 307/200/401/401/200 (#58)
```
...
**Commit message:**
```
fix(uiux): skeleton loading states settings tabs (U7)
```
