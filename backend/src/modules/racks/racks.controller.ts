...
export class RacksController {
  ...
  create(@Body() createRackDto: CreateRackDto, @Request() req) {
  ...
  findAll(@Query('siteId') siteId: string, @Request() req) {
  ...
  update(@Param('id') id: string, @Body() updateRackDto: UpdateRackDto, @Request() req) {
