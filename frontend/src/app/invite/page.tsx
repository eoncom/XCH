        ...
        <Card className="w-full max-w-md shadow-lg">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-lg font-semibold">Compte activé !</p>
              <p className="text-sm text-muted-foreground">
                Votre mot de passe a été défini. Vous allez être redirigé vers la page de connexion...
              </p>
              <Button onClick={() => router.push('/login')} variant="outline">
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Activez votre compte en définissant votre mot de passe</CardDescription>
        </CardHeader>
        <CardContent>
